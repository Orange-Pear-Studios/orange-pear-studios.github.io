...
/** @type {string} */
const CACHE_VERSION = '1765939427|311392923';
/** @type {string} */
const CACHE_PREFIX = 'dark lanterns-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'dark lanterns.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["dark lanterns.html","dark lanterns.js","dark lanterns.offline.html","dark lanterns.icon.png","dark lanterns.apple-touch-icon.png","dark lanterns.audio.worklet.js","dark lanterns.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["dark lanterns.wasm","dark lanterns.pck","dark lanterns.side.wasm"];
